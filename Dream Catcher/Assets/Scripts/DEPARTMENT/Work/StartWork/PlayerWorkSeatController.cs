...
public class PlayerWorkSeatController : MonoBehaviour
{
    ...
    [Tooltip("Ќасколько опустить камеру при посадке.")]
    public Vector3 sittingCameraLocalOffset =
        new Vector3(0f, -0.35f, 0f);

    [Header("Initial Sitting View")]
    [Tooltip("Ќачальный вертикальный угол взгл€да после посадки. ќтрицательное значение Ч выше.")]
    ...
    [Tooltip("–азмер зоны у краЄв экрана, поворачивающей камеру.")]
