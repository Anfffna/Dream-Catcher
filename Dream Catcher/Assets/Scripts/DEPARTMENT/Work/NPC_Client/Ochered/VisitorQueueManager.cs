    ...
    MonoBehaviour
{
    ...
    {
        // =====================================================
        // ДАЁМ ВСЕМ ОБРАБОТАТЬ CLIENT FINISHED
        // =====================================================

        // ClientFinished уже означает, что последняя
        // анимация клиента полностью закончилась.
        //
        // Один кадр нужен, чтобы все остальные
        // подписчики ClientFinished успели отработать.
        yield return null;


        // =====================================================
        // СКРЫВАЕМ ЗАКОНЧЕННОГО КЛИЕНТА
        // =====================================================
        ...
        // =====================================================
        // СБРАСЫВАЕМ ФОРМУ ПРОШЛОГО КЛИЕНТА
        // =====================================================

        // Это делаем после КАЖДОГО клиента,
        // в том числе после последнего.
        if (directionFormResetController != null)
        {
            directionFormResetController
                .ResetForm();
        }
        ...
        // =====================================================
        // ПОДГОТАВЛИВАЕМ СИСТЕМЫ ДЛЯ СЛЕДУЮЩЕГО
        // =====================================================
