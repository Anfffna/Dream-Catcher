...
public class WorkMouseInteractionController : MonoBehaviour
{
    ...
    private void Update()
    {
        // Во время паузы курсором управляет PauseManager.
        ...
        // Во время диалога клик обрабатывает только DialogueManager.
        // Камера при этом продолжает работать через PlayerController.
